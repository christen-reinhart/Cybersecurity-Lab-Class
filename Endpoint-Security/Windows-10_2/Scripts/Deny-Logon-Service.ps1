# File: 2.2.18-DenyServiceLogon.ps1
$LogPath = "$env:SystemDrive\\CIS-Hardening-Logs"
if (-not (Test-Path $LogPath)) { New-Item -Path $LogPath -ItemType Directory | Out-Null }
$LogFile = "$LogPath\\2.2.18-DenyServiceLogon.log"
...
& $ntrights -m \\$env:COMPUTERNAME -u "Guests" +r SeDenyServiceLogonRight

Write-Host "✅ 'Deny log on as a service' set to Guests."
Stop-Transcript
